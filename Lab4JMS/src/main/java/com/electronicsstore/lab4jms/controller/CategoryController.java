...
import com.electronicsstore.lab4jms.repository.CategoryRepository;
...
public class CategoryController {
    ...
    public ResponseEntity<Category> updateCategory(@PathVariable int id, @RequestBody Category categoryDetails) {
        ...
        if (categoryOptional.isPresent()) {
            ...
            changeLogService.logChange("UPDATE", "Customer", updatedCategory.getId(), updatedCategory.toString());
    ...
    public ResponseEntity<HttpStatus> deleteCategory(@PathVariable int id) {
        try {
            ...
            changeLogService.logChange("DELETE", "Category", id, "Category deleted");
