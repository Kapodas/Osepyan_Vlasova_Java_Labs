package com.electronicsstore.lab4jms.controller;

import com.electronicsstore.lab4jms.repository.CustomerRepository;
import com.electronicsstore.lab4jms.repository.OrderRepository;
import com.electronicsstore.lab4jms.repository.ProductRepository;
import com.electronicsstore.lab4jms.service.ChangeLogService;
import com.electronicsstore.lab4jms.table.Customer;
import com.electronicsstore.lab4jms.table.Order;
import com.electronicsstore.lab4jms.table.Product;
...
public class OrderController {
    ...
    public ResponseEntity<Order> createOrder(@RequestBody OrderRequest orderRequest) {
        ...
        if (customer != null && product != null) {
            ...
            changeLogService.logChange("INSERT", "Customer", savedOrder.getId(), savedOrder.toString());
    ...
    public ResponseEntity<Order> updateOrder(@PathVariable int id, @RequestBody OrderRequest orderRequest) {
        ...
        if (orderOptional.isPresent()) {
            ...
            if (customer != null && product != null) {
                ...
                changeLogService.logChange("UPDATE", "Customer", updatedOrder.getId(), updatedOrder.toString());
    ...
    public ResponseEntity<HttpStatus> deleteOrder(@PathVariable int id) {
        try {
            ...
            changeLogService.logChange("DELETE", "Order", id, "Order deleted");
